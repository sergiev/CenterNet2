...
st_categories = [{'id': 0, 'name': '~'}, {'id': 1, 'name': '!'}, {'id': 2, 'name': '"'},
                 ...
                 {'id': 15, 'name': '/'}, {'id': 16, 'name': '0'}, {'id': 17, 'name': '1'},
                 {'id': 18, 'name': '2'}, {'id': 19, 'name': '3'}, {'id': 20, 'name': '4'},
                 {'id': 21, 'name': '5'}, {'id': 22, 'name': '6'}, {'id': 23, 'name': '7'},
                 {'id': 24, 'name': '8'}, {'id': 25, 'name': '9'}, {'id': 26, 'name': ':'},
                 {'id': 27, 'name': ';'}, {'id': 28, 'name': '<'}, {'id': 29, 'name': '='},
                 {'id': 30, 'name': '>'}, {'id': 31, 'name': '?'}, {'id': 32, 'name': '@'},
                 {'id': 33, 'name': 'A'}, {'id': 34, 'name': 'B'}, {'id': 35, 'name': 'C'},
                 {'id': 36, 'name': 'D'}, {'id': 37, 'name': 'E'}, {'id': 38, 'name': 'F'},
                 {'id': 39, 'name': 'G'}, {'id': 40, 'name': 'H'}, {'id': 41, 'name': 'I'},
                 {'id': 42, 'name': 'J'}, {'id': 43, 'name': 'K'}, {'id': 44, 'name': 'L'},
                 {'id': 45, 'name': 'M'}, {'id': 46, 'name': 'N'}, {'id': 47, 'name': 'O'},
                 {'id': 48, 'name': 'P'}, {'id': 49, 'name': 'Q'}, {'id': 50, 'name': 'R'},
                 {'id': 51, 'name': 'S'}, {'id': 52, 'name': 'T'}, {'id': 53, 'name': 'U'},
                 {'id': 54, 'name': 'V'}, {'id': 55, 'name': 'W'}, {'id': 56, 'name': 'X'},
                 {'id': 57, 'name': 'Y'}, {'id': 58, 'name': 'Z'}, {'id': 59, 'name': '['},
                 {'id': 60, 'name': '\\'}, {'id': 61, 'name': ']'}, {'id': 62, 'name': '^'},
                 {'id': 63, 'name': '_'}, {'id': 64, 'name': '`'}, {'id': 65, 'name': '{'},
                 {'id': 66, 'name': '|'}, {'id': 67, 'name': '}'}]
